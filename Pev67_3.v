...
Definition ew3 :=  (get_position 6 7 ev3).1.
Definition eb3 :=  (get_position 6 7 ev3).2.
...
Proof.
suff : valid_eval 6 7 ew3 eb3 win.
  by rewrite /valid_eval; case/or3P: (@evalOr 6 7 isT isT ew3 eb3) => /eqP->.
rewrite -eval_ev3E.
